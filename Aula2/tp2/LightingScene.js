...
LightingScene.prototype.init = function(application) {
	...
	this.materialA.setAmbient(0,0,0.2,1);
	this.materialA.setDiffuse(0,0,0.2,1);
	this.materialA.setSpecular(0.8,0.8,0.8,1);
	this.materialA.setShininess(120);

	this.materialB = new CGFappearance(this);
	this.materialB.setAmbient(0,0,0.2,1);
	this.materialB.setDiffuse(0,0,0.2,1);
	this.materialB.setSpecular(0.8,0.8,0.8,1);	
	this.materialB.setShininess(120);

	this.materialC = new CGFappearance(this); //material das paredes
	this.materialC.setAmbient(1,0.97,0.7,1);
	this.materialC.setDiffuse(1,0.97,0.7,1);
	this.materialC.setSpecular(0.8,0.8,0.8,1);	
	this.materialC.setShininess(120);

	this.Dmaterial = new CGFappearance(this); //material do chao
	this.Dmaterial.setAmbient(0.3, 0.3, 0.3, 1);
	this.Dmaterial.setDiffuse(0.3, 0.3, 0.3, 1);
	//this.Dmaterial.setDiffuse(0.47, 0.29, 0.13, 1);
	this.Dmaterial.setSpecular(0.9, 0.9, 0.9,1);
	this.Dmaterial.setShininess(120);
...
LightingScene.prototype.initLights = function() {
	...
	this.lights[0].setPosition(4, 7, 4, 1);
	this.lights[1].setPosition(10.5, 7.0, 4.0, 1.0);
