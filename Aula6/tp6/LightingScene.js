...
LightingScene.prototype.init = function(application) {
	...
	this.droneAppearances= [ '..//resources/images/yellow.png' , '..//resources/images/blue.png' , '..//resources/images/red.png','..//resources/images/yellow2.png' ,'..//resources/images/blue2.png'  ,'..//resources/images/red2.png'];
	this.droneAppearanceList = ['Yellow', 'Red', 'Blue' ];
	this.currDroneAppearance = ['Red']; 
	...
	this.pillarAppearance.setDiffuse(0.9,0.9,0.9,1);
	this.pillarAppearance.setSpecular(0,0.2,0.8,1);
	...
	this.boxAppearance.loadTexture("..//resources/images/dhl.png");

	this.boxAppearancepicked = new CGFappearance(this);
	this.boxAppearancepicked.loadTexture("..//resources/images/dhlpicked.png");

	this.warningAppearance = new CGFappearance(this);
	this.warningAppearance.loadTexture("..//resources/images/warning.png");
...
LightingScene.prototype.update = function (currTime){
	...
	this.diff +=  currTime - this.LastTime;
...
LightingScene.prototype.initLights = function() {
	...
	// Positions for four lights
		...
		// Positions for four lights
	this.lights[0].setPosition(4, 8, 5.5, 1);
	this.lights[1].setPosition(10.5, 8.0, 5.5, 1.0);
	this.lights[2].setPosition(10.5, 8.0, 11.0, 1.0);
	this.lights[3].setPosition(4, 8.0, 11.0, 1.0);
	
	this.lights[4].setPosition(0, 4, 7.7, 1.0);
...
//	this.lights[3].setQuadraticAttenuation(0.1); //Kq
	...
	this.lights[4].setLinearAttenuation(0.3); //Kl
//	this.lights[4].setQuadraticAttenuation(0.1); //Kq
	this.lights[4].enable();

	this.lights[5].setAmbient(0, 0, 0, 1);
	this.lights[5].setDiffuse(0.8, 0.2, 0.2, 1.0);
	this.lights[5].setSpecular(1.0, 1.0, 0.0, 1.0);
	this.lights[5].setConstantAttenuation(0); //Kc
	this.lights[5].setLinearAttenuation(0.3); //Kl
	this.lights[5].setQuadraticAttenuation(0.1); //Kq
	this.lights[5].setPosition(14, 0.5, 14, 1.0);
...
///Box
	this.pushMatrix();
	if (this.box.picked == 0){
		this.boxAppearance.apply();
	}
		else {this.boxAppearancepicked.apply();}
		this.box.display();
	this.popMatrix();

	//Drone
	this.pushMatrix();
		this.translate(this.drone.MotionX,this.drone.Height,this.drone.MotionZ);
